...
def train(args, model, labeled_dloader, unlabeled_dloader, criterion, optimizer):
    model.train()
    losses, accs = [], []
...
def run_experiment():
    ...
    # for epoch in range(1, args..n_epochs + 1):
        ...
        loss, acc = train(args, model, labeled_dloader, unlabeled_dloader, criterion, optimizer, )
