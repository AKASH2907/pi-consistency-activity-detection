...
class HyperParameters():
    def parse(self, unknown_arg_ok=False):
        ...
        # parser.add_argument('--yv_root', help='YouTubeVOS data root', default='../YouTube')  # ORIGINAL
        parser.add_argument('--yv_root', help='YouTubeVOS data root', default='/datasets/YouTube-VOS/2019/train')    # NEW
        parser.add_argument('--davis_root', help='DAVIS data root', default='../DAVIS')

        parser.add_argument('--stage', help='Training stage (0-static images, 1-Blender dataset, 2-DAVIS+YouTubeVOS (300K), 3-DAVIS+YouTubeVOS (150K))', type=int, default=2)
        ...
        # since it's not NULL everything will be logged
        # parser.add_argument('--id', help='Experiment UNIQUE id, use NULL to disable logging to tensorboard', default='debug')
        ...
        if self.args['stage'] == 0:
            ...
            self.args['iterations'] = none_or_default(self.args['iterations'], 75000)
