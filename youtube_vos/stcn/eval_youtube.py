...
# parser.add_argument('--model', default='saves/Aug02_12.43.20_sup_100per/Aug02_12.43.20_sup_100per_30000.pth')

# parser.add_argument('--model', default='saves/Aug02_15.16.08_debug_subset_train/Aug02_15.16.08_debug_subset_train_5000.pth')

# parser.add_argument('--model', default='saves/Aug05_05.12.06_sup_100per_simple/Aug05_05.12.06_sup_100per_simple_37500.pth')
# parser.add_argument('--model', default='saves/Aug09_17.39.59_sup_10per_simple_lr1e4/Aug09_17.39.59_sup_10per_simple_lr1e4_10000.pth')
parser.add_argument('--model', default='saves/Aug09_23.09.34_us_try_1_seg_const_20_80/Aug09_23.09.34_us_try_1_seg_const_20_80_30000.pth')

# parser.add_argument('--yv_path', default='../YouTube')
parser.add_argument('--yv_path', default='/datasets/YouTube-VOS/2019')
