...
from train_utils import SpreadLoss, get_accuracy, DiceLoss, IoULoss, FocalLoss
...
if __name__ == '__main__':
    ...
    for e in tqdm(range(1, N_EPOCHS + 1)):
        if e < 2:
            wt_cons_cls = 0
            r, train_loss = train(model, labeled_train_data_loader, unlabeled_train_data_loader, optimizer, e, r, save_path, writer, 
                args.wt_seg, args.wt_cls, wt_cons_cls, args.const_loss, short=False)

        elif e<8:
            wt_cons_cls = args.wt_cons_cls//10
            r, train_loss = train(model, labeled_train_data_loader, unlabeled_train_data_loader, optimizer, e, r, save_path, writer, 
                args.wt_seg, args.wt_cls, wt_cons_cls, args.const_loss, short=False)
        else:
            wt_cons_cls = args.wt_cons_cls
            r, train_loss = train(model, labeled_train_data_loader, unlabeled_train_data_loader, optimizer, e, r, save_path, writer, 
                args.wt_seg, args.wt_cls, wt_cons_cls, args.const_loss, short=False)
